...
dnl #
VERSIONID(`$Id: sendmail.mc,v 5.32 2007/12/11 10:45:38 ak Exp $')dnl
...
dnl #
define(`SENDMAILROOT',`/usr/local/sendmail')dnl
define(`CF',`SENDMAILROOT/etc')dnl
...
define(`confHOST_STATUS_DIRECTORY',`SENDMAILROOT/var/hoststat')dnl
define(`HELP_FILE',`CF/helpfile')dnl
define(`QUEUE_DIR',`SPOOL/mqueue/q.*')dnl
define(`STATUS_FILE',`-o CF/sendmail.st')dnl
define(`confPID_FILE',`SENDMAILROOT/var/run/sendmail.pid')dnl
...
define(`confDEF_USER_ID',`sendmail')dnl
define(`confSMTP_LOGIN_MSG',`$j LOCAL-SENDMAIL')dnl
...
dnl #  FEATURE(`smrsh',`SENDMAILROOT/sbin/smrsh') Sendmail Restricted shell
...
dnl #
FEATURE(`use_ct_file')
FEATURE(`smrsh',`SENDMAILROOT/sbin/smrsh')
